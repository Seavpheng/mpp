package lab_10.prob_3;

import lab_7.prob_1.partE.ClassD.E;

import java.util.Arrays;
import java.util.List;
import java.util.stream.Collectors;

import static lab_10.prob_3.FunctionWithException.unchecked;
...
public class FixThis {
	...
	public static void main(String[] args) {
		...
		List<String> words1 = Arrays.asList("not", "hello", "too", "big", "yet");
