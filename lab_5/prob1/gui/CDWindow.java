...
import lab_5.prob1.rulesets.CDRuleSet;
import lab_5.prob1.rulesets.RuleException;
import lab_5.prob1.rulesets.RuleSet;
import lab_5.prob1.rulesets.RuleSetFactory;
...
public class CDWindow extends JFrame  {
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt){
			String strArtist = artistField.getText();
			...
			try {
				...
				sb.append("CD Details: " + n);
				sb.append("Artist: " + strArtist + n);
				sb.append("Title: " + strTitle + n);
				sb.append("Price: " + strPrice);
				JOptionPane.showMessageDialog(CDWindow.this, sb);
